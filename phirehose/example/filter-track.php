...
class FilterTrackConsumer extends OauthPhirehose
{
  ...
  public function enqueueStatus($status)
  {
      ...
      if (is_array($data) && isset($data['user']['screen_name'])) {
                ...
                $ok = mysql_query("INSERT INTO guitar (text, screen_name, followers_count, created_at, entry_stamp) VALUES ('$text', '$screen_name', '$followers_count', '$created_at', NOW())"); 
...
$sc->setTrack(array('guitar','guitar%20lessons','playing%20guitar'));
$sc->consume();
